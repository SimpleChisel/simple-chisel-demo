...
object Main extends App {
  ...
  val chirrtl_IndependenceDemo = firrtl.Parser.parse(chisel3.Driver.emit(() => new IndependenceDemo))
  val writer_IndependenceDemo = new FileWriter(new File(dir, s"${chirrtl_IndependenceDemo.main}.fir"))
  writer_IndependenceDemo write chirrtl_IndependenceDemo.serialize
  writer_IndependenceDemo.close
